#!/usr/bin/env bash
#SBATCH --job-name=reve_ft_resub
#SBATCH --output=/home/mat/scratch/EEG_results/logs/reve_ft_resub_%j.out
#SBATCH --error=/home/mat/scratch/EEG_results/logs/reve_ft_resub_%j.err
...
SAVE_DIR="/home/mat/scratch/EEG_results/results/finetuned_param/reve/base/balanced"
...
echo "Starting REVE Fine-tuning Resubmission Array Task $SLURM_ARRAY_TASK_ID"
