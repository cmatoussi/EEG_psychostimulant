#!/usr/bin/env bash
#SBATCH --job-name=reve_ft
#SBATCH --output=/home/mat/projects/EEG_psychostimulant/logs/reve_ft_%j.out
#SBATCH --error=/home/mat/projects/EEG_psychostimulant/logs/reve_ft_%j.err
...
SAVE_DIR="/home/mat/projects/EEG_psychostimulant/data/results/finetuned_param/reve/base/balanced"
...
echo "Starting REVE Fine-tuning Job Array Task $SLURM_ARRAY_TASK_ID"
echo "  - Condition: $COND"
echo "  - Fold: $FOLD_IDX"
...
python3 /home/mat/projects/EEG_psychostimulant/eeg_adhd_epilepsy/dl/reve/fine_tune/reve_finetune_base.py \
    --data-root "$DATA_ROOT" \
    --label-csv "$LABEL_CSV" \
    --save-dir "$SAVE_DIR" \
    --conditions "$COND" \
