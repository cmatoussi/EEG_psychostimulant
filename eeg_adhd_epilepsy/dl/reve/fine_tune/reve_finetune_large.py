...
# Model IDs
REVE_MODEL_ID = "brain-bzh/reve-large"
...
def main():
    ...
    parser.add_argument("--save-dir", default="/home/mat/projects/EEG_psychostimulant/data/results/finetuned_param/reve/large/balanced", help="Directory to save fine-tuned parameters.")
    ...
    for fold, (train_idx, val_idx) in enumerate(skf.split(epoch_metadata, y, groups=subjects)):
        ...
        save_path = save_dir / f"reve_finetuned_fold{fold+1}_{cond_suffix}_large.pt"
        metrics_path = save_dir / f"reve_metrics_fold{fold+1}_{cond_suffix}_large.json"
    ...
    results_csv = save_dir / "finetune_results_reve_large.csv"
    ...
    try:
        ...
        # Fallback
        results_df.to_csv(save_dir / f"finetune_results_{cond_suffix}_large.csv", index=False)
