#!/usr/bin/env python3
"""
EC Classification Performance: CBraMod vs REVE (with/without fine-tuning)
...
def load_fold_rows(path, condition="EC_baseline"):
...
for label, path in files.items():
    df = load_fold_rows(path, condition="EC_baseline")
...
ax.set_title("EC Classification Performance: CBraMod vs REVE", pad=18, weight="bold")
ax.set_ylabel("Score")
ax.set_xticks(x)
...
out_base = "/home/mat/projects/EEG_psychostimulant/data/results/EC_CBraMod_REVE_finetuning_comparison"
